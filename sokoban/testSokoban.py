...
import functools
import search
from mySokobanSolver import check_elem_action_seq,SokobanPuzzle
...
if __name__ == "__main__":
    ...
    wh.load_warehouse("./warehouses/warehouse_91.txt")#warehouse_8a
    print(wh.worker)
    print(wh.boxes)
    ...
    res=check_elem_action_seq(wh,['Up','Right','Up','Right','Right'])
    print(res)
